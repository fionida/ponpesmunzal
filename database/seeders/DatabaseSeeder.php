    ...
    public function run(): void
    {
        ...
        SiteProfile::query()->updateOrCreate(
            ...
            [
                ...
                'about' => 'Pondok Pesantren Nurul Munzal berdiri sebagai lembaga pendidikan Islam yang memadukan pengajian kitab, tahfidz, dan pendidikan formal. Santri dibina secara utuh: ibadah, akhlak, dan kecakapan hidup.',
        ...
        foreach ([
            ...
            ['Profil Pondok Pesantren Nurul Munzal', 'Kegiatan Harian', 'video'],
        ...
        $pageContents = [
            ['beranda', 'beranda.hero_eyebrow', 'Hero eyebrow', 'text', 'PONDOK PESANTREN NURUL MUNZAL'],
            ...
            ['beranda', 'beranda.hero_btn_primary', 'Tombol hero utama', 'text', 'Tentang Pondok'],
            ['beranda', 'beranda.hero_btn_secondary', 'Tombol hero kedua', 'text', 'Pendaftaran Santri Baru'],
            ...
            ['beranda', 'beranda.stat_label_years', 'Label statistik tahun', 'text', 'Tahun Berdiri'],
            ['beranda', 'beranda.stat_label_students', 'Label statistik santri', 'text', 'Santri Aktif'],
            ['beranda', 'beranda.stat_label_teachers', 'Label statistik pengajar', 'text', 'Tenaga Pengajar'],
            ['beranda', 'beranda.stat_label_alumni', 'Label statistik alumni', 'text', 'Alumni'],
            ['beranda', 'beranda.programs_eyebrow', 'Program eyebrow', 'text', 'PROGRAM PENDIDIKAN'],
            ['beranda', 'beranda.programs_title', 'Program judul', 'text', 'Pendidikan Menyeluruh untuk Masa Depan'],
            ['beranda', 'beranda.sambutan_eyebrow', 'Sambutan eyebrow', 'text', 'SAMBUTAN PENGASUH'],
            ...
            ['beranda', 'beranda.gallery_eyebrow', 'Galeri eyebrow', 'text', 'KEHIDUPAN SANTRI'],
            ['beranda', 'beranda.gallery_title', 'Galeri judul', 'text', 'Langkah Kecil, Cerita Besar'],
            ['beranda', 'beranda.news_eyebrow', 'Berita eyebrow', 'text', 'BERITA TERKINI'],
            ['beranda', 'beranda.news_title', 'Berita judul', 'text', 'Informasi & Kegiatan'],
            ...
            ['beranda', 'beranda.cta_button', 'CTA tombol', 'text', 'Daftar Sekarang →'],
            ...
            ['profil', 'profil.hero_title', 'Hero judul', 'text', 'Profil Pondok Pesantren Nurul Munzal'],
            ...
            ['profil', 'profil.sekilas_eyebrow', 'Sekilas eyebrow', 'text', 'SEKILAS PROFIL'],
            ['profil', 'profil.sekilas_title', 'Sekilas judul', 'text', 'Rumah ilmu yang merawat adab'],
            ...
            ['profil', 'profil.visi_eyebrow', 'Visi eyebrow', 'text', 'ARAH PENDIDIKAN'],
            ['profil', 'profil.visi_title', 'Visi judul', 'text', 'Visi, Misi & Tujuan'],
            ['profil', 'profil.sejarah_eyebrow', 'Sejarah eyebrow', 'text', 'SEJARAH SINGKAT'],
            ['profil', 'profil.sejarah_title', 'Sejarah judul', 'text', 'Tumbuh dari niat, merawat amanah'],
            ...
            ['profil', 'profil.fasilitas_eyebrow', 'Fasilitas eyebrow', 'text', 'SARANA & PRASARANA'],
            ['profil', 'profil.fasilitas_title', 'Fasilitas judul', 'text', 'Fasilitas yang menunjang ibadah dan belajar'],
            ['profil', 'profil.prestasi_eyebrow', 'Prestasi eyebrow', 'text', 'PRESTASI'],
            ['profil', 'profil.prestasi_title', 'Prestasi judul', 'text', 'Capaian yang tumbuh dari proses'],
            ['profil', 'profil.prestasi_items', 'Prestasi (satu baris per item)', 'textarea', "Juara tahfidz tingkat kabupaten\nPengabdian santri di masyarakat\nAlumni tersebar di berbagai lembaga"],
            ['profil', 'profil.cta_title', 'CTA judul', 'text', 'Mari menjadi bagian dari keluarga besar Nurul Munzal'],
            ['profil', 'profil.cta_text', 'CTA teks', 'textarea', 'Pendaftaran santri baru dibuka. Konsultasikan program yang sesuai bersama panitia.'],
            ['profil', 'profil.cta_button', 'CTA tombol', 'text', 'Daftar Sekarang'],
            ...
            ['pendidikan', 'pendidikan.highlights', 'Highlight (satu baris per item)', 'textarea', "Kurikulum Terpadu\nPembinaan Karakter\nLingkungan Islami\nTenaga Pengajar Kompeten"],
            ['pendidikan', 'pendidikan.programs_eyebrow', 'Program eyebrow', 'text', 'PROGRAM PENDIDIKAN'],
            ['pendidikan', 'pendidikan.programs_title', 'Program judul', 'text', 'Program Pendidikan'],
            ...
            ['pendidikan', 'pendidikan.metode_title', 'Judul metode', 'text', 'Metode Pembelajaran'],
            ...
            ['pendidikan', 'pendidikan.fasilitas_eyebrow', 'Fasilitas eyebrow', 'text', 'FASILITAS PENDIDIKAN'],
            ['pendidikan', 'pendidikan.fasilitas_title', 'Fasilitas judul', 'text', 'Sarana Belajar yang Lengkap'],
            ['pendidikan', 'pendidikan.jadwal_eyebrow', 'Jadwal eyebrow', 'text', 'KEGIATAN BELAJAR SANTRI'],
            ['pendidikan', 'pendidikan.jadwal_title', 'Jadwal judul', 'text', 'Ritme harian yang membentuk'],
            ['pendidikan', 'pendidikan.jadwal_text', 'Jadwal teks', 'textarea', 'Dari tahajud hingga istirahat malam, setiap waktu diisi dengan ibadah, belajar, dan istirahat yang seimbang.'],
            ['pendidikan', 'pendidikan.aside_ar', 'Aside Arab', 'text', 'الْعِلْمُ نُورٌ'],
            ['pendidikan', 'pendidikan.aside_title', 'Aside judul', 'text', 'Ilmu adalah cahaya'],
            ['pendidikan', 'pendidikan.aside_text', 'Aside teks', 'textarea', 'Cahaya itu merawat hati, menuntun langkah, dan membuat manfaat sampai kepada orang lain.'],
            ['pendidikan', 'pendidikan.cta_title', 'CTA judul', 'text', 'Bersama Kami, Wujudkan Masa Depan yang Lebih Baik.'],
            ['pendidikan', 'pendidikan.cta_text', 'CTA teks', 'textarea', 'Konsultasikan jenjang dan program yang sesuai dengan putra-putri Anda.'],
            ['pendidikan', 'pendidikan.cta_button', 'CTA tombol', 'text', 'Daftar Sekarang'],
            ...
            ['kegiatan', 'kegiatan.quote_by', 'Sumber kutipan', 'text', 'KH. Ahmad Fauzi, Lc.'],
            ['kegiatan', 'kegiatan.list_eyebrow', 'List eyebrow', 'text', 'KEGIATAN TERBARU'],
            ['kegiatan', 'kegiatan.list_title', 'List judul', 'text', 'Informasi Kegiatan Pesantren'],
            ...
            ['kegiatan', 'kegiatan.galeri_eyebrow', 'Galeri eyebrow', 'text', 'DOKUMENTASI'],
            ['kegiatan', 'kegiatan.galeri_title', 'Galeri judul', 'text', 'Galeri Kegiatan'],
            ['kegiatan', 'kegiatan.cta_title', 'CTA judul', 'text', 'Mari Dukung Kegiatan Pesantren'],
            ['kegiatan', 'kegiatan.cta_text', 'CTA teks', 'textarea', 'Dukungan Anda membantu kegiatan belajar, ibadah, dan pengabdian santri tetap berjalan.'],
            ['kegiatan', 'kegiatan.cta_button', 'CTA tombol', 'text', 'Hubungi Kami'],
            ...
            ['berita', 'berita.list_eyebrow', 'List eyebrow', 'text', 'BERITA TERBARU'],
            ['berita', 'berita.list_title', 'List judul', 'text', 'Berita Terkini'],
            ['berita', 'berita.list_text', 'List teks', 'textarea', 'Informasi terbaru dari kehidupan dan kegiatan pondok.'],
            ['berita', 'berita.cta_title', 'CTA judul', 'text', 'Dukung pendidikan santri'],
            ['berita', 'berita.cta_text', 'CTA teks', 'textarea', 'Kontribusi Anda membantu kegiatan belajar dan pembinaan tetap berjalan.'],
            ['berita', 'berita.cta_button', 'CTA tombol', 'text', 'Dukung Kami'],
            ...
            ['galeri', 'galeri.foto_title', 'Judul galeri foto', 'text', 'Galeri Foto'],
            ['galeri', 'galeri.foto_text', 'Teks galeri foto', 'text', 'Kumpulan dokumentasi kegiatan pondok.'],
            ['galeri', 'galeri.video_title', 'Judul galeri video', 'text', 'Galeri Video'],
            ['galeri', 'galeri.cta_title', 'CTA judul', 'text', 'Setiap Foto, Punya Cerita'],
            ['galeri', 'galeri.cta_text', 'CTA teks', 'textarea', 'Kirim dokumentasi kegiatan yang pantas dibagikan kepada keluarga besar pondok.'],
            ['galeri', 'galeri.cta_button', 'CTA tombol', 'text', 'Kirim Dokumentasi'],
            ...
            ['kontak', 'kontak.form_title', 'Judul formulir', 'text', 'Formulir Kontak'],
            ['kontak', 'kontak.subjects', 'Opsi subjek (satu baris per item)', 'textarea', "Pertanyaan Pendaftaran\nKerja Sama\nSaran & Masukan\nLainnya"],
            ['kontak', 'kontak.aside_quote', 'Kutipan samping form', 'textarea', 'Silaturahmi adalah jembatan menuju keberkahan dan kemajuan bersama.'],
            ['kontak', 'kontak.help_items', 'Kartu bantuan (judul|teks per baris)', 'textarea', "Pertanyaan Seputar Pendaftaran|Jadwal, syarat, dan program yang sesuai.\nKerja Sama|Kunjungan, pengajian, dan kolaborasi lembaga.\nSaran & Masukan|Kami terbuka merawat mutu pelayanan pondok."],
            ...
            ['kontak', 'kontak.cta_title', 'CTA judul', 'text', 'Mari Terhubung dan Bersinergi'],
            ['kontak', 'kontak.cta_text', 'CTA teks', 'textarea', 'Tim pondok siap membantu pertanyaan pendaftaran dan kerja sama.'],
            ['kontak', 'kontak.cta_button', 'CTA tombol', 'text', 'Hubungi Kami Sekarang'],
            ...
            ['pendaftaran', 'pendaftaran.quote', 'Kutipan hero', 'textarea', 'Tuntutlah ilmu dari buaian hingga liang lahat.'],
            ['pendaftaran', 'pendaftaran.quote_by', 'Sumber kutipan', 'text', 'Hadis'],
            ['pendaftaran', 'pendaftaran.form_title', 'Judul formulir', 'text', 'Formulir Pendaftaran Awal'],
            ['pendaftaran', 'pendaftaran.form_text', 'Teks formulir', 'textarea', 'Lengkapi data calon santri. Tidak perlu akun. Proses ini hanya pendaftaran awal.'],
            ['pendaftaran', 'pendaftaran.docs_title', 'Judul dokumen', 'text', 'Yang perlu disiapkan'],
            ['pendaftaran', 'pendaftaran.help_title', 'Judul bantuan', 'text', 'Butuh bantuan?'],
            ['pendaftaran', 'pendaftaran.help_text', 'Teks bantuan (pakai {whatsapp} {email} {hours})', 'textarea', 'Hubungi panitia di {whatsapp} atau {email} pada {hours}.'],
        ];
